...
const TITLES: Record<string, { title: UiTextKey; description: UiTextKey }> = {
  ...
  '/valuation': { title: 'layout.route.valuation.title', description: 'layout.route.valuation.description' },
  '/my-dashboard': { title: 'layout.route.myDashboard.title', description: 'layout.route.myDashboard.description' },
  '/filings': { title: 'layout.route.filings.title', description: 'layout.route.filings.description' },
  '/overview': { title: 'layout.route.overview.title', description: 'layout.route.overview.description' },
  '/discipline': { title: 'layout.route.discipline.title', description: 'layout.route.discipline.description' },
